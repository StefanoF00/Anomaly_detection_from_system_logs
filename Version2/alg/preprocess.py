...
if __name__ == '__main__':
    ...
    # Parser #
    ##########
    input_dir = './data_to_parse/OpenStack/'
    output_dir = 'alg/spell_results/'
    parsed_dir = 'data_parsed/OpenStack/'
    ...
    train_file = os.path.join(parsed_dir, 'train')
    deeplog_file_generator(train_file, deeplog_train)

    ###############
    # Test Normal #
    ###############
    deeplog_test_normal = deeplog_df_transfer(df_normal, event_id_map)
    test_normal_file = os.path.join(parsed_dir, 'test_normal')
    deeplog_file_generator(test_normal_file, deeplog_test_normal)
